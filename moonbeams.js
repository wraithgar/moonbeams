...
(function () {
    ...
    // Create a safe reference to the Moonbeams object for use below.
    var Moonbeams = function (obj) {
        if (obj instanceof Moonbeams) {
            return obj;
        }
        if (!(this instanceof Moonbeams)){
            return new Moonbeams(obj);
        }
    };

    // Export Moonbeams for node.js or browser
    if (typeof exports !== 'undefined') {
        if (typeof module !== 'undefined' && module.exports) {
            exports = module.exports = Moonbeams;
        }
        exports.Moonbeams = Moonbeams;
    } else {
        root.Moonbeams = Moonbeams;
    }
    ...
    var degreeToRadian = Moonbeams.degreeToRadian =  function (degrees) {
